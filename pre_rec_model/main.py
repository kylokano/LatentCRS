...
from rec_trainers import ICLRecTrainer
from rec_models import SASRecModel
...
def main():
    ...
    parser.add_argument("--model_idx", default="0", type=str, help="model description")
    ...
    args.data_file = args.data_dir + args.data_name + "/" + args.data_name + ".csv"
    ...
    with open(os.path.join(args.output_dir, args_str + "_config.json"), 'w', encoding='utf8') as f:
    ...
    if args.do_eval:
        ...
        for epoch in range(args.epochs):
            ...
            early_stopping(np.array(scores[-1:]), trainer.model, trainer.clusters)
